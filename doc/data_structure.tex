...
\newcommand{\stacknotes}{
  ...
  &\tabitem Push, i.e., insert, to add new element to top&&\\
  &\tabitem Pop, i.e., delete,  to remove top element&&\\
  &\tabitem Underflows if attempt to pop an empty stack&&\\
  &\tabitem Overflows if attempt to push to a full stack&&\\
}
\begin{landscape}
